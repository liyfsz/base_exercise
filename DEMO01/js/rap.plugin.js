...
(function (window, undefined) {
    var node = null;
    var blackList = [];
    var whiteList = ["xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","/index","mockData","toBeCopy","RapModalData.json","mockData","data.json","investList"];

    var ROOT = "rap.taobao.org";
    var LOST = "LOST";
    var PREFIX = "/mockjs/";
    var EMPTY_ARRAY = "EMPTY_ARRAY";
    var TYPE_NOT_EQUAL = "TYPE_NOT_EQUAL";
